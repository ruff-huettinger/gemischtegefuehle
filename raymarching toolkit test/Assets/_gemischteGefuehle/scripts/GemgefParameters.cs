...
public class GemgefParameters : MonoBehaviour {
    ...
    public float[] stepsSL01 = new float[] { 0f, 0.2f, 0.4f, 0.6f, 0.8f, 1f };
    public float SL02Teilung;
    public float[] stepsSL02 = new float[] { 0, .33f, .66f, 1 };
    public float SL03Muster;
    public float[] stepsSL03 = new float[] { 0, .3f, .6f, 1 };
    public float SL04Bewegung;
    public float[] stepsSL04 = new float[] { 0, .1f, .2f , .3f, .4f, .55f, .7f, .9f ,  1};
    public float SL06Varianz;
    public float[] stepsSL06 = new float[] { 0, 1 };
    public float SL05Aggregatzustand;
    public float[] stepsSL05 = new float[] { 0, .6f, 1 };
    public float SL07Kontrast;
    public float[] stepsSL07 = new float[] { 0, .2f,.5f,.8f, 1 };
    public float SL08Helligkeit;
    public float[] stepsSL08 = new float[] { 0, .2f, .5f, .8f, 1 };
    ...
    void Update() {
        ...
        if (!prohibitUpdate)
        {
            ...
            lense.focalLength = Mathf.Clamp(lense.focalLength + BenjasMath.mapSteps(SL05Aggregatzustand, stepsSL05, new float[] { 0f, 0.05f, 9f }),0,100);
