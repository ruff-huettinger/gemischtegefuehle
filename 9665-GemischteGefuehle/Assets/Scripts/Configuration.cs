...
public class Configuration
{
    ...
    static public float GetInnerTextByTagName(string tagname, float defaultFloat, int count = 0)
    {
        LoadConfig();
       
        string s = GetInnerTextByTagName(tagname, defaultFloat.ToString(), count);
        if (s != "")
        {
